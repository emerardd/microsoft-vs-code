...
const STRINGS = {
  en: {
    runVictory: "BUILD PASSED",
    runGoal: "5 waves + final boss · Aim for a five-minute run",
    runComplete: "All five waves cleared. Final boss defeated.",
    openingUpgrade: "Choose your starting upgrade",
    openingUpgradeHint: "One choice now, then one after each of the first four waves.",
    runStage: "Wave {wave}/5",
    finalBossStage: "Final boss",
    wavesClearedLabel: "Waves cleared",
    loadoutTitle: "Starting configuration",
    metaSummary: "{waves} waves cleared · {wins} wins · Permanent HP +{hp}/10",
    loadout_standard: "Standard",
    loadout_spread: "Spread",
    loadout_pierce: "Piercing",
    loadout_standard_desc: "Weapon level 1.",
    loadout_spread_desc: "Weapon level 2; diagonal shots.",
    loadout_pierce_desc: "Weapon level 1 + Piercing level 1.",
    unlockSpread: "Unlock: clear 5 waves in total.",
    unlockPierce: "Unlock: win your first run.",
    metaHpRule: "Every 5 cleared waves: +2 permanent HP, up to +10. New bonuses apply next run.",
    profileSaveFailed: "Progress could not be saved. This session is still playable.",
    victoryTime: "Clear time",

    runReport: "Run report",
    survivalTime: "Survival time",
    deathCause: "Final hit",
    mainDamage: "Most damage from",
    upgradeRoute: "Upgrade route",
    noUpgrades: "No upgrades selected yet.",
    contactTip: "Keep some distance from enemies; use Refactor when surrounded.",
    projectileTip: "Move across incoming fire and save Refactor for dense bullet patterns.",
    checkpointRestored: "Wave v{wave}.0 checkpoint restored. Continue when ready.",
    continueRun: "Continue run",
    entityCountLabel: "Active entities",
    projectileCountLabel: "Projectiles",
    updateTimeLabel: "Simulation CPU",
    renderTimeLabel: "Canvas CPU",
    upg_PIERCE_title: "Piercing types",
    upg_PIERCE_desc: "Each bullet hits one more enemy per level. Maximum 2 levels.",
    upg_RICOCHET_title: "Reflect API",
    upg_RICOCHET_desc: "Bullets bounce off a side wall once. Adds diagonal shots if needed. Maximum 1 level.",
    upg_LAST_STAND_title: "Buffer pressure",
    upg_LAST_STAND_desc: "At 25% ammo or less, gain 25% damage per level. Maximum 2 levels.",
    ...
    refactorHudCharging: 'REFACTOR CHARGE',
    refactorHudReady:    'REFACTOR READY · PRESS R',
    ...
    feat5:            'Upgrades: One starting choice + four wave choices',
    ...
    statusHeap: 'Open entity diagnostics',
  ...
  zh: {
    runVictory: "构建成功",
    runGoal: "5 波杂兵 + 最终 Boss · 熟练后约 5 分钟一局",
    runComplete: "已完成全部 5 波并击败最终 Boss。",
    openingUpgrade: "选择本局起始升级",
    openingUpgradeHint: "现在选择一次，前四波结束后各再选择一次。",
    runStage: "第 {wave}/5 波",
    finalBossStage: "最终 Boss",
    wavesClearedLabel: "已完成波次",
    loadoutTitle: "起手配置",
    metaSummary: "累计清波 {waves} · 通关 {wins} 次 · 永久生命 +{hp}/10",
    loadout_standard: "标准起手",
    loadout_spread: "散射起手",
    loadout_pierce: "穿透起手",
    loadout_standard_desc: "武器等级 1。",
    loadout_spread_desc: "武器等级 2，附带斜射弹。",
    loadout_pierce_desc: "武器等级 1 + 穿透 1 级。",
    unlockSpread: "解锁：累计完成 5 波。",
    unlockPierce: "解锁：首次通关。",
    metaHpRule: "每累计完成 5 波永久 +2 生命，上限 +10；新增加成从下一局生效。",
    profileSaveFailed: "进度保存失败，本次会话仍可继续游玩。",
    victoryTime: "通关用时",
    ...
    upgradeRoute: "升级路线",
    noUpgrades: "本局尚未选择升级。",
    contactTip: "尽量与敌人保持距离，被包围时使用重构清场。",
    projectileTip: "横向避开来袭弹幕，密集时保留重构用于清场。",
    checkpointRestored: "已恢复 v{wave}.0 波次检查点，准备好后继续。",
    continueRun: "继续本局",
    entityCountLabel: "活动实体",
    projectileCountLabel: "弹幕数量",
    updateTimeLabel: "逻辑耗时",
    renderTimeLabel: "绘制提交耗时",
    upg_PIERCE_title: "类型穿透",
    upg_PIERCE_desc: "每层让子弹额外穿透一个敌人，最多 2 层。",
    upg_RICOCHET_title: "反射 API",
    upg_RICOCHET_desc: "子弹可在侧壁反弹一次；基础武器也会获得斜射弹，最多 1 层。",
    upg_LAST_STAND_title: "缓冲区压力",
    upg_LAST_STAND_desc: "弹药不高于 25% 时每层增伤 25%，最多 2 层。",
    ...
    refactorHudCharging: '重构充能',
    refactorHudReady:    '重构就绪 · 按 R',
    ...
    panelInfoDebug: '运行和调试面板显示帧间隔、实体数、连击、代码行数和最高分等实时指标。',
