...
const STRINGS = {
  en: {
    ...
    upg_RICOCHET_desc: "Bullets bounce off side walls once per level. Adds diagonal shots if needed. Maximum 2 levels.",
  ...
  zh: {
    ...
    upg_RICOCHET_desc: "每层可在侧壁反弹一次；基础武器也会获得斜射弹，最多 2 层。",
